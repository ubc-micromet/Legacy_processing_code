...
rdir <-"/Users/ziyi/Google Drive/.shortcut-targets-by-id/1txCh9lZ7VGCujXGvBaJCMVnuxT-65q4K/Micromet Lab/Projects/2022-RBM Richmond brackish marsh/Flux-tower/met_data/cr1000"
...
files <- c("DTA.csv", "ORP.csv", "PAR.csv",
  ...
  "NDVI.csv","PRI.csv","WVA.csv","WDA.csv","PSA.csv","FCA.csv","FMA.csv")

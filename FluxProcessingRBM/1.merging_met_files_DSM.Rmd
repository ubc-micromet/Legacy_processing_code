...
getwd()
siteID <- 'RBM'
rdir <- "/Users/ziyi/Google Drive/.shortcut-targets-by-id/1txCh9lZ7VGCujXGvBaJCMVnuxT-65q4K/Micromet\ Lab/Projects/2022-RBM Richmond brackish marsh/Flux-tower/met_data/" # working directory
...
cr1000 <- read.csv(paste(siteID,"DTA.csv",sep=""),
                   header = TRUE,
                   sep = ",")

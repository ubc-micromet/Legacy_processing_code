...
path <- "/Users/darianng/Google\ Drive/My\ Drive/Micromet\ Lab/Projects/2019-Burns\ Bog\ 2/Flux-tower/EP_outputs"
...
write.csv(cont.DS,paste('/Users/darianng/Google\ Drive/My\ Drive/Micromet\ Lab/Projects/2019-Burns\ Bog\ 2/Flux-tower/flux_data/BB2_L1','.csv',sep =''),row.names=FALSE)

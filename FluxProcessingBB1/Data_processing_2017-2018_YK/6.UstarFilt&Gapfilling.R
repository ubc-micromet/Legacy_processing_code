#This Rscript generates the input files for the Reddyproc online tool
#performs U star filtering first and then,
#It generates final input files for the final online gapfilling
...
##########
  ...
  #For BB:
final<-read.csv( paste('./BB_FILTERED','.csv',sep=""),sep=",",header=TRUE,dec=".")

#Adding NEE , 
#Decision: I decided to use the CO2 storage component generated by EDDY pro which is bases in oune point measurements. 
...
write.table(DATA, file = paste('./for_gapfilling','.txt',sep=''),row.names=FALSE,sep='\t')   
